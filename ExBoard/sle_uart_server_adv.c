...
/* 广播ID */
#define SLE_ADV_HANDLE_DEFAULT                    11
/* 最大广播数据长度 */
#define SLE_ADV_DATA_LEN_MAX                      251
/* 广播名称 */
static uint8_t sle_local_name[NAME_MAX_LENGTH] = "hisoc -ExBoard";
unsigned char local_addr[SLE_ADDR_LEN] = { 0x03, 0x02, 0x03, 0x04, 0x05, 0x06 };
